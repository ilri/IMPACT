...
otherexpenses::otherexpenses(QWidget *parent, QSqlDatabase db, QString systemID) :
    QWidget(parent),
    ui(new Ui::otherexpenses)
{
    ui->setupUi(this);
    dataBase = db;
...
{
    //qDebug() << "Before destroy otherexpenses UI";
    delete ui;
    //qDebug() << "After destroy otherexpenses UI";
}

void otherexpenses::loadAndroidEffects()
{
...
void otherexpenses::loadForm()
{
    ...
    m_periodModel->setTableName("otherhhexpperiods");
...
void otherexpenses::constructCustomDelegator()
{
...
void otherexpenses::loadChildData(QModelIndex index)
{
...
void otherexpenses::setChildStatus(bool status)
{
...
void otherexpenses::setParentStatus(bool status)
{
...
void otherexpenses::childDataChanged()
{
...
void otherexpenses::dataChanged()
{
    setChildStatus(false);
...
void otherexpenses::on_BitBtn14_clicked()
{
    m_colModel->insertNewItem();
}

void otherexpenses::on_BitBtn15_clicked()
{
    QModelIndex idx;
...
void otherexpenses::on_BitBtn9_clicked()
{
...
void otherexpenses::on_BitBtn10_clicked()
{
...
void otherexpenses::on_BitBtn11_clicked()
{
...
void otherexpenses::on_BitBtn12_clicked()
{
...
void otherexpenses::afterApply(QList<TmoduleInsertedKeys> insertedKeys)
{
    ...
    for (pos =0; pos <= insertedKeys.count()-1;pos++)
    {
        ...
        {
            sql = "INSERT INTO otherexpensesperiods (";
...
void otherexpenses::loadDetCalc (const QModelIndex &index)
{
    bool rowOk;
    bool colOk;
    rowOk = false;
