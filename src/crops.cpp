    ...
    ui(new Ui::crops)
{
    ...
    MProducts->setTableName("cropprods");
    ...
    MForages->setTableName("cropfora");
...
void crops::chekitem(maintModel *model, QModelIndex index)
{
...
void crops::blockChildData()
{
    setChildStatus(false);
}

void crops::loadMaintenance(QSqlDatabase db,QTableView *tableView)
{
...
void crops::productsDataChanged()
{
...
void crops::setMasterStatus(bool status)
{
...
void crops::setChildStatus(bool status)
{
...
void crops::on_BitBtn10_clicked()
{
...
void crops::on_BitBtn6_clicked()
{
    ...
    mntdlg.setWindowTitle("Crop products maintenance");
    mntdlg.exec();
...
void crops::on_BitBtn5_clicked()
{
    ...
    mntwindow->loadMaintenance(database,mntwindow->list);
    mntdlg.setMaintWindow(mntwindow);
    mntdlg.setWindowTitle("Crop forages maintenance");
    mntdlg.exec();
